...
import RPutAwayConfirm from "./RPutAwayConfirm";

function RPutAwayProcess() {
  ...
  const navigatePutAwayConfirm = () => {
    // 👇️ navigate to /contacts
    navigate("/RPutAwayConfirm");
  };
  // </Route>;
  ...
  return (
    <div className="App container">
      ...
      <br />
      <h1 className="RPORFunctionName">Put Away</h1>
      ...
      <div className="information">
        <form action="">
          ...
          <div className="mb-3">
            <label htmlFor="LPN Number" className="form-label">
              LPN Number
            </label>
            <input
              type="text"
              className="form-control"
              placeholder="Scan LPN Number"
              required
              onChange={(event) => {
      ...
      <button
        ...
        onClick={navigatePutAwayConfirm}
      >
          ...
          <div className="LoadPlan Detail">
            <div className="card-body text-left">
              ...
              <div className="d-flex">
                ...
                <Routes>
                  <Route
                    path="/RPutAwayConfirm"
                    element={<RPutAwayConfirm />}
                  />
                </Routes>
...
export default RPutAwayProcess;
